...
static const CharacterFormOffsets MARIO_OFFSETS = {
    // normalForm
    { {{1,  6}, {16, 18}}, {{18,  6}, {16, 18}}, {{52,  6}, {16, 18}}, {{154, 1}, {16, 24}}, {15.f, 18.f} },
    // superForm
    { {{1, 31}, {16, 26}}, {{18, 31}, {16, 26}}, {{52, 31}, {16, 26}}, {{154, 1}, {16, 24}}, {15.f, 26.f} },
    // fireForm
    { {{1, 64}, {16, 26}}, {{18, 64}, {16, 26}}, {{52, 64}, {16, 26}}, {{154, 1}, {16, 24}}, {15.f, 26.f} },
};
