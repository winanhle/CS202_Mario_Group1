    ...
    )
{
    ...
    if (m_fontLoaded)
    {
        ...
        m_titleText.setPosition({WIN_W / 2.f, 60.f});
        ...
        m_scoreLabelText.setFillColor(
            sf::Color(200, 220, 255)
        );
        centerOrigin(m_scoreLabelText);
        m_scoreLabelText.setPosition(
            {WIN_W / 2.f, 240.f}
        );

        // Lives bonus
        int livesBonus =
            std::max(0, m_livesRemaining) *
        ...
        m_livesBonusText.setFillColor(
            sf::Color(180, 240, 180)
        );
        centerOrigin(m_livesBonusText);
        m_livesBonusText.setPosition(
            {WIN_W / 2.f, 268.f}
        );
        ...
        m_totalScoreText.setFillColor(
            sf::Color(255, 235, 80)
        );
        m_totalScoreText.setOutlineColor(
            sf::Color::Black
        );
        m_totalScoreText.setOutlineThickness(2.f);
        centerOrigin(m_totalScoreText);
        m_totalScoreText.setPosition(
            {WIN_W / 2.f, 305.f}
        );
